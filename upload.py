...
"""
    ## PipeCone
    DATA_URL: https://narratear-xle6sb1.svc.aped-4627-b74a.pinecone.io
...
def chunk(docs, chunk_size = 100, chunk_overlap=0.25):
    #Chunk -> nodes
...
def init_pipecone():
    ...
    index_name = "narratear"
    if index_name not in pc.list_indexes().names():
        #Embedding output dimension = 384
        pc.create_index(name='narratear', dimension=384, metric="cosine", spec=PodSpec(environment="gcp-starter"))
        # connect to index
